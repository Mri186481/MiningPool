...
public class ConsoleOutput extends OutputStream {
    //La clase ConsoleOutput hereda de OutputStream. Un OutputStream es básicamente una "tubería" por donde viajan datos (bytes).
    ...
    //Recibe un solo numero entero, que representa un caracter ASCII
    //lo convierto en caracter, luego a texto y lo mando pintar en la pantalla(append)
    //NO SE UTILIZA, pero es obligatorio, la clase OutputStream exige que exista

    @Override
    public void write(byte[] b, int off, int len) throws IOException {
        // Redirige bloques de texto (más eficiente para println)
